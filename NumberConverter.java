...
class Convert{
    static void decimalToBinary(int decimal){
        String strBinary = Integer.toBinaryString(decimal); // it take int value as input and return string value as output
    ...
    static void binaryToDecimal(String strBinary){
        int decimal = Integer.valueOf(strBinary,2); // as it is binary so radix value is 2. Value of return int(premetive) type data
